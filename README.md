...
> up, then upload a short audio file (`.mp3` / `.m4a`) to try it.



## What it does

* Transcribes the audio into text (Whisper)
...
Uploading a file kicks off a background job so the page never freezes. The audio
...
* Keep test clips short and use audio, not video — Whisper caps uploads around 25 MB.
